...
# from metrics_gen.StructuralLosses.StructuralLossesBackend import NNDistance, NNDistanceGrad
try:
    from .StructuralLossesBackend import NNDistance, NNDistanceGrad
except ModuleNotFoundError:
    # Supports an uninstalled local build_ext result during development.
    from StructuralLossesBackend import NNDistance, NNDistanceGrad
# from .StructuralLossesBackend import NNDistance, NNDistanceGrad
